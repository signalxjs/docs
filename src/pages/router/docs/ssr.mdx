...
Use a navigation guard to redirect before the page is rendered. On the server
the redirect happens in memory — the Express handler can check the final URL
and send a 302:
