...
Thanks for your interest! This repo holds the source for <https://signalx.dev> — the documentation site for [SignalX](https://github.com/signalxjs/core). Other SignalX packages (router, store, UI kit, SSG, live-code, monaco-editor) live in their own repositories under [`signalxjs`](https://github.com/signalxjs).
